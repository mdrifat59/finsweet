        ...
        <>
            <section className='py-8 lg:py-16 xl:py-32 bg-white'>
                <div className='w-full px-4 sm:px-8 lg:max-w-container lg:mx-auto'>
                    ...
                    <div className='w-full flex flex-col md:flex-row justify-center items-center pt-10 lg:pt-16 gap-6'>
                        <div className="">
                            <label className='font-Roboto_Regular text-xs md:text-sm lg:text-base text-[#161722]'> OUR MISSIOn & Vision </label>
                            <h4 className='w-[300px] lg:w-[371px] sm:my-4 font-Roboto_Bold text-xl sm:text-2xl lg:text-[32px] text-[#161722] lg:leading-[44px]'>STRIVING FOR A BETTER TOMORROW </h4>
                            <p className='w-[300px] lg:w-[372px] lg:my-4 font-Roboto_Regular text-xs md:text-sm lg:text-base text-[#161722] leading-6'>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.
                            </p>
                        </div>
                        <div className="">
                            <label className='font-Roboto_Regular text-xs md:text-sm lg:text-base text-[#161722]'> WHAT WE DO </label>
                            <h4 className='w-[300px] lg:w-[371px] sm:my-4 font-Roboto_Bold text-xl sm:text-2xl lg:text-[32px] text-[#161722] lg:leading-[44px]'>BRINgING PEACE AND JOY TO THE WORLD </h4>
                            <p className='w-[300px] lg:w-[372px] lg:my-4 font-Roboto_Regular text-xs md:text-sm lg:text-base text-[#161722] leading-6'>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.
                            </p>
                        </div>
