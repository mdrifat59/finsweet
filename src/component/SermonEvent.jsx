  ...
  return (
    <>
      <div className='py-12 md:py-14 lg:py-16 xl:py-[128px] bg-[#f5f2f0]'>
        ...
        <div className='text-center mb-8 sm:mb-12 lg:mb-16 mt-5 lg:mt-24'>
          <h2 className='font-Roboto_Bold text-2xl md:text-3xl lg:text-5xl uppercase text-[#161722] mt-4'>Upcoming Sermons</h2>
        </div>
