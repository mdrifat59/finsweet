                    ...
                    <div className='w-full flex flex-wrap 2xl:flex-nowrap  gap-4 justify-center'>
                        <div className='w-[302px] bg-[#FFF5EB] group block'>
                            <div className='py-12 px-8'>
                                ...
                                <h5 className='w-[218px] font-Roboto_Bold text-2xl text-[#161722] py-4'>WATCH AND LISTEN TO OUR SERMONS</h5>
                                <p className='w-[238px] font-Roboto_Regular text-base text-[#161722]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
                                <div className='pt-12'>
                                    <label className='font-Roboto_Regular text-lg text-[#161722]'>By Mathew Johnson</label>
                                    <p className='font-Roboto_Regular text-base text-[#161722]'>Tuesday 13 May, 2021</p>
                                </div>
                            </div>
